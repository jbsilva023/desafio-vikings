        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" name="razao" id="razao" value="{{ $_REQUEST['razao'] }}" class="form-control">
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" value="{{ $_REQUEST['email'] }}" class="form-control">
                </div>
            </div>
            <div class="col-md-4 col-sm-12">
